...
const await = async (media) => new Promise(async (resolve, reject) => {
...
module.exports = { tts, await, simih, getBuffer, h2k, generateMessageID, getGroupAdmins, getRandom, start, info, success, banner, close, pickRandom }
